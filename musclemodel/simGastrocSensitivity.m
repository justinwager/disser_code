function [q, fm, fl, fv, lmtu, lt, lf, vf, tstr] = simGastrocSensitivity(ankle, knee, moments, dt, params)
...
fm = moments ./ d;
totalParts = ratio + 1;
gastrocPortion = 1 / totalParts;
fm = fm * gastrocPortion;  % gastroc only so reduce force requirement
